...
const About: React.FC = () => {
  ...
  const profileImageUrl = "/portfolio/PXL_20250612_081923276.jpg"; // Replace with your actual profile picture URL

  return (
    <section
      id="about"
      ref={sectionRef}
      className={`min-h-screen pt-24 pb-16 px-4 flex flex-col justify-center transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'
        }`}
    >
              ...
              <div className="w-64 h-64 bg-blue-100 rounded-full flex items-center justify-center overflow-hidden border-4 border-white shadow-lg">
                <img
                  ...
                  className="w-full h-full object-cover "
                   style={{ objectPosition: 'center 60%' }} // adjust % for perfect center
                  onError={(e) => {
